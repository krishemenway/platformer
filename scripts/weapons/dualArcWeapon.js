...
define(["weapons/weapon", "projectiles/oscillatingProjectile"], function(Weapon, OscillatingProjectile) {
	...
	var DualArcWeapon = Weapon.extend({
		...
		createProjectiles: function() {
			this.sceneProjectiles[this.weaponOwner.team()].push(this.createProjectile(0));
			this.sceneProjectiles[this.weaponOwner.team()].push(this.createProjectile(90));
		},

		createProjectile: function(initialLife) {
			...
			return new OscillatingProjectile(initialX, initialY, 5, 5, this.projectileVelocity * projectileDirection, initialLife);
		},
